export function SkeletonCharacterCard() {
    return (
        <div role="status" className="w-[290px] sm2:w-[330px] h-[219px] rounded-[5px] dark:bg-[#b87f65] animate-pulse transition-opacity duration-500">
            <div className="w-[290px] sm2:w-[330px] h-[132px] dark:bg-[#e9a07f] rounded-t-[5px]"></div>
